...
// Get details of a specific Sculpture by ID
...
// Render details of a specific sculpture
...
exports.Sculptures_delete = async function (req, res) {
  ...
  try {
    ...
    console.log("Removed sculpture:", sculpture);
    res.json(sculpture); // Send the deleted sculpture as confirmation
  } catch (err) {
